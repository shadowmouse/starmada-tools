...
export const weaponTraitConfigs = {
    ...
    "cutting" : { multiplier: 1.5, label: "Cutting" , short_code: "Ctg", prohibited: ["sweeping"] }, 
    "defensive" : { multiplier: 1, label: "Cutting" , short_code: "Dfs", prohibited: ["missile"] },
    ...
    "fullisade-1" : { multiplier: 2, label: "Fullisade" , short_code: "Fl1", prohibited: [] },
    "fullisade-2" : { multiplier: 3, label: "Fullisade 2" , short_code: "Fl2", prohibited: [] },
    "fullisade-3" : { multiplier: 3, label: "Fullisade 3" , short_code: "Fl3", prohibited: [] },
    "incapacitating" : { multiplier: 0.7, label: "Incapacitating" , short_code: "Inc", prohibited: [] },
    "kinetic" : { multiplier: 3, label: "Kinetic" , short_code: "Knt", prohibited: [] },
    "missile" : { multiplier: 0.6, label: "Missile" , short_code: "Msl", prohibited: ["defensive", "sustained"] },
    "overload" : { multiplier: 2, label: "Overload" , short_code: "Ol1", prohibited: [] },
    "overload-2" : { multiplier: 3, label: "Overload 2" , short_code: "Ol2", prohibited: [] },
    "overload-3" : { multiplier: 3, label: "Overload 3" , short_code: "COl3", prohibited: [] },
    "non-phasing" : { multiplier: 0.7, label: "Non-Phasing" , short_code: "Nph", prohibited: [] },
    "phasing" : { multiplier: 1.4, label: "Phasing" , short_code: "Ph1", prohibited: [] },
    "phasing-2" : { multiplier: 1.8, label: "Phasing 2" , short_code: "Ph2", prohibited: [] },
    "phasing-3" : { multiplier: 2.2, label: "Phasing 3" , short_code: "Ph3", prohibited: [] },
    "piercing-auto" : { multiplier: 2, label: "Piercing Auto" , short_code: "PrA", prohibited: ["resonant", "semi-piercing"] },
    "piercing-4" : { multiplier: 1.5, label: "Piercing 4" , short_code: "Pr4", prohibited: ["resonant", "semi-piercing"] },
    "piercing-6" : { multiplier: 1.2, label: "Piercing 5" , short_code: "Pr5", prohibited: ["resonant", "semi-piercing"] },
    ...
    "repeating-4" : { multiplier: 2, label: "Repeating-4" , short_code: "Rp4", prohibited: ["retargeting"] },
    "repeating-5" : { multiplier: 1.5, label: "Repeating-5" , short_code: "Rp5", prohibited: ["retargeting"] },
    "repeating-6" : { multiplier: 1.2, label: "Repeating-6" , short_code: "Rp6", prohibited: ["retargeting"] },
    "resonant" : { multiplier: 1.5, label: "Resonant" , short_code: "Res", prohibited: ["piercing", "semi-piercing"] },
    "retargeting" : { multiplier: 1.5, label: "Retargeting" , short_code: "Rtg", prohibited: ["repeating"] },
    ...
    "salvo-fire" : { multiplier: 1, label: "Salvo Fire" , short_code: "Sal", prohibited: ["chain-fire"] },
    "semi-piercing" : { multiplier: 1.5, label: "Semi-Piercing" , short_code: "Sep", prohibited: ["piercing", "resonant"] },
    ...
    "sustained" : { multiplier: 1.3, label: "Sustained" , short_code: "Sus", prohibited: ["missile", "slow"] },
    "sweeping" : { multiplier: 1.5, label: "Sweeping" , short_code: "Swp", prohibited: ["cutting"] },
